...
function ProcessDetailsGroup({ messageCount, toolCallCount, children }: { messageCount: number; toolCallCount: number; children: ReactNode }) {
  ...
  const parts = ["处理过程", `${messageCount} 条消息`];
...
export function ChatWindow({ session, newSessionCwd, onAgentEnd, onSessionCreated, onSessionForked, modelsRefreshKey, chatInputRef, onBranchDataChange, branchTree, branchActiveLeafId, onBranchLeafChange, onToggleBranchPanel, onSystemPromptChange, onSessionStatsChange, onSessionStatsPanelOpen, onToggleSessionStatsPanel, onContextUsageChange, onOpenFile, onManageSkills, onOpenSystemPrompt }: Props) {
  ...
  // 欢迎界面随机鼓励语（惰性初始化，每次进入欢迎界面固定一句，不会反复跳变）
  ...
  const chatInputElement = (
    <ChatInput
      ...
      onToggleBranchPanel={onToggleBranchPanel}
      onManageSkills={onManageSkills}
      onOpenSessionInfo={onToggleSessionStatsPanel}
